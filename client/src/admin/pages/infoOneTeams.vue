  ...
  <div class="xl:container mx-auto px-6 md:px-12">
    ...
    <div class="grid gap-6 px-4 sm:px-0 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
     <div class="group relative rounded-2xl  space-y-6 overflow-hidden">
        <img
          class="mx-auto h-[18rem] w-full grayscale object-cover object-top ransition duration-500 group-hover:scale-105 group-hover:grayscale-0"
          ...
          height="805"
        />
        <div class="absolute bottom-0 inset-x-0 h-max mt-auto px-8 py-6 bg-gray-800 dark:bg-gray translate-y-24 transition duration-300 ease-in-out group-hover:translate-y-0">
          <div>
